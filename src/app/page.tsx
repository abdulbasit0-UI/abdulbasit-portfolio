      ...
      <main className="max-w-4xl mx-auto  px-6 py-12 flex-1">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Jun 2020 – Dec 2021</p>
              <ul className="list-disc list-inside mt-2 text-gray-700 dark:text-gray-300 space-y-1">
        ...
        <section className="mb-16">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">University of Engineering & Tech, 2016–2020</p>
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Graduated with honors. Thesis: &quot;Efficient Data Extraction in Dynamic Web Environments&quot;
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Tech: Python, Scrapy, Docker, MongoDB
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Tech: NestJS, Redis, Docker, Kubernetes
              </p>
            </div>
          </div>
        </section>
